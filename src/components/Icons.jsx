...
export function IconFeedback({ className }) {
  return (
    <svg
      className={className}
...
export function IconOrganisation({ className }) {
  return (
    <svg
      className={className}
      xmlns="http://www.w3.org/2000/svg"
...
export function IconPasskey({ className }) {
  return (
    <svg
      className={className}
      xmlns="http://www.w3.org/2000/svg"
...
export function IconAnswer({ className }) {
  return (
    <svg
      className={className}
      xmlns="http://www.w3.org/2000/svg"
...
export function IconStreaming({ className }) {
  return (
    <svg
      className={className}
      xmlns="http://www.w3.org/2000/svg"
